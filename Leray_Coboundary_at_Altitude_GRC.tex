...
%  Synthica x NSRI Global Research Challenge submission
%  Author: Vaibhav Shakya
%  Format: strict GRC template compliance
% ============================================================
...
\usepackage[a4paper,margin=1in,top=1.25in,bottom=1in]{geometry}
...
\definecolor{synblue}{HTML}{1B4FA8}
...
\newcommand{\grcheader}{%
  \begin{tikzpicture}[baseline=0]
    \node[circle, fill=synblue, inner sep=2pt, minimum size=8pt] (sm) at (0,0)
      {\textbf{\textcolor{white}{\scriptsize S}}};
    \node[right=2pt of sm, font=\sffamily\small\bfseries, text=synblue] (sname) {Synthica};
    \node[right=10pt of sname, font=\sffamily\footnotesize\bfseries, text=synblue!75] (nsri) {NSRI};
    \node[right=2pt of nsri, font=\sffamily\scriptsize, align=left, anchor=west] {National Student\\Research Institution};
  \end{tikzpicture}%
}

\pagestyle{fancy}
\fancyhf{}
\fancyhead[C]{\grcheader}
