...
function footer(slide, pageNum, total) {
  slide.addText("Leray's Coboundary at Altitude  ·  Vaibhav Shakya  ·  2026", {
...
async function main() {
  ...
  s.addText("Cellular Sheaf Theory for Radiation Hardness", {
  ...
  s.addText("Vaibhav Shakya  ·  Jayshree Periwal International School  ·  2026", {
    x: 0.6, y: 5.30, w: 9.0, h: 0.22,
    fontFace: FONT_BODY, fontSize: 10, color: "B6BFD0", italic: true, margin: 0,
  });

  // Save
  const out = path.join(__dirname, "Leray_Coboundary_at_Altitude.pptx");
