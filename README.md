...
This is the full reproducibility package for the paper by Vaibhav Shakya (Jayshree Periwal International School, Jaipur).

**Paper**: [`Leray_Coboundary_at_Altitude.pdf`](Leray_Coboundary_at_Altitude.pdf) (26 pages)
**Deck**: [`Leray_Coboundary_at_Altitude.pptx`](Leray_Coboundary_at_Altitude.pptx) (16 slides)
...
├── LICENSE
├── requirements.txt
├── Leray_Coboundary_at_Altitude.pdf        Final 26-page paper
├── Leray_Coboundary_at_Altitude.tex        LaTeX source
├── Leray_Coboundary_at_Altitude.pptx       16-slide presentation deck
...
pdflatex Leray_Coboundary_at_Altitude.tex
pdflatex Leray_Coboundary_at_Altitude.tex              # second pass for refs
...
Both proofs appear in full in `Leray_Coboundary_at_Altitude.tex`. The symbolic correctness of Theorem 2 part (b) is verified by `experiments/verify_separation_proof.py`.
